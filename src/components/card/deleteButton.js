...
//                                 <button type="button" className="btn btn-info" onClick={()=>{this.handleClickDeletePassage()}}>Delete</button>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
...
//                 <button type="button" className="btn btn-info" data-toggle="modal" data-target={"#deleteModal" + this.props.passage.id}>
//                     Delete
//                 </button>
//             </div>
//         );
